...
async function startServer() {
  ...
  route("all", "/api/auth/providers", (req, res) => {
    req.query = { ...(req.query || {}), route: "providers" };
    return auth(req, res);
  });
  ...
  for (const alias of ["connection", "disconnect", "list-prs", "read-pr", "list-issues", "comment", "create-pr", "merge-pr", "push", "create-repo", "list-repos", "list-branches", "checkout"]) {
