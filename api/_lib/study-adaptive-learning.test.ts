...
function event(correct: boolean, misconceptionSignal = false): StudyMasteryEvidenceEvent {
  return {
    id: 'event-1', conceptId: 'concept-1', kind: misconceptionSignal ? 'misconception_probe' : 'assessment_item',
    ...
    provenance: 'quantora_authored', observedAt: '2026-08-29T00:00:00.000Z',
  };
}
