 ...
 *
 * This does not try to reproduce PowerPoint's text renderer. It blocks the
 * repeatable failure modes we can know before compilation: overlong headlines,
 * oversized bullet regions, verbose semantic cards, repeated visible copy, and
 * slide-level text density that would force unreadable font shrinking.
 */
 ...
 *
 * Structural, executive-communication and readability quality must all pass
 * BEFORE compilation. Keeping these checks in the AI repair loop means weak
 * headlines, thin decision support, evidence-boundary problems and likely
 * overflow/density failures are repaired before the user sees version 1.
 */
