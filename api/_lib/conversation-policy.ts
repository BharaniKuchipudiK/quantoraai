...
- For a shop, boutique, catalog, or when the user asks for images: every product and hero MUST use a real \`<img src="https://images.unsplash.com/...">\` photo (silk, textile, product, apparel). Never SVG empty frames, CSS-only silhouettes, or gold placeholders. Do not tell the user images are done unless those img tags exist in the HTML.
