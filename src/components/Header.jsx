          ...
          {user && (
            <div ref={modelRef} style={{ position: 'relative' }}>
              ...
              >
                ...
                <span>{selectedModel ? selectedModel.name : "Auto Smart Router"}</span>
              ...
              {showModelDropdown && (
                <div style={{
                  ...
                  <div style={{ fontSize: '0.75rem', color: subtextColor, padding: '4px 8px', fontWeight: '600' }}>
                    ACTIVE OPEN MODEL GATEWAY
                  </div>
                  {availableModels.map(model => (
                    ...
                    >
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', fontSize: '0.85rem', fontWeight: '600', color: selectedModel?.id === model.id ? '#f97316' : textColor }}>
                        <span>{model.name}</span>
                        <span style={{ fontSize: '0.65rem', background: 'rgba(16, 185, 129, 0.15)', color: '#059669', padding: '1px 5px', borderRadius: '4px' }}>
                          {model.badge}
                        </span>
                      </div>
                      <span style={{ fontSize: '0.7rem', color: subtextColor }}>{model.specialty}</span>
                    </div>
                  ))}
                </div>
              )}
