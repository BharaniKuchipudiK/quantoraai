...
export function shouldGenerateOfficeNow({ text = '', officeKind = null, messages = [] } = {}) {
  ...
  // Continue action emits the canonical approval value below, so the user never
  // has to discover or type an approval phrase themselves.
